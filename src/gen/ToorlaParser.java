...
public class ToorlaParser extends Parser {
	...
	public static class ClassDeclarationContext extends ParserRuleContext {
		...
		public FieldDeclarationContext classField;
		...
		try {
			...
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 3648L) != 0) {
				...
				case 1:
					{
					setState(104);
					((ClassDeclarationContext)_localctx).classField = fieldDeclaration();
					}
					break;
				case 2:
					{
	...
	public final StatementVarDefContext statementVarDef() throws RecognitionException {
		...
		try {
			...
			match(T__17);
			setState(256);
			((StatementVarDefContext)_localctx).myVar = match(ID);
			setState(257);
			match(T__18);
			setState(258);
			((StatementVarDefContext)_localctx).assign = expression();
			setState(265);
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (_la==T__6) {
